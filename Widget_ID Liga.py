...
for nummer in liganummer:
    url = "https://www.basketball-bund.net/widget/widgets/#!/widgetgenerator/liga/" + \
        str(nummer) + "/verein/977"
    print(url)
    driver.get(url)
...
with open('data/Liga/Widget_ID.txt', 'w') as file:
