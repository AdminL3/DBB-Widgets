...
rows = zip(indeces, namen, ordnungszahl, altersklasse,
           geschlecht, mannschafts_ID, widget_ID, code_snippets_big2, code_snippets_small2)


# Write the header to the worksheet
worksheet.append(['Index', 'Name', 'Ordnungszahl', 'Altersklasse',
                  'Geschlecht', 'Mannschafts_ID', 'Widget ID', 'Code groß', 'Code klein'])
